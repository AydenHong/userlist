...
app.get('/topic/add', (req,res)=>{
    ...
    db.query(sql , (err, result)=>{
        ...
        console.log(result)
        res.render('add',{topics : result}) //res.send 일때도 생각해보기
    })
})
...
app.post('/topic/add', (req, res)=>{
    ...
    //`INSERT INTO topic (title, description, author) VALUES (${title}, ${description}, ${author})`;
